...
public class AdopBoardEntity { // 입양 게시글 VO
	int id;
	int animalId;
	int memberId;
	...
	public AdopBoardEntity() {	super();	}

	public AdopBoardEntity(int id, int animalId, int memberId, int process, Date regDate, Date visitDate) {
		super();
		this.id = id;
